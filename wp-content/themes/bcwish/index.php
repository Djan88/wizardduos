      ...
      <div class="modal-content">
        ...
        <div class="modal-text">
          <div class="row" style="text-align: center;padding: 20px;font-size: 23px;">
            ...
            <div class="col-sm-12">
              Для работы в программе ширина экрана должна быть не менее 600px. При меньшей ширине возможно наложение фотографий и зон друг на друга что снижает качество проработки. Если Вы хотите продолжить работу на этом устройстве, то просто закройте это сообщение.
            </div>
          </div>
        </div>
      </div>
