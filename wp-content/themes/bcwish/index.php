        ...
        <div class="row justify-content-center align-self-center">
          <div class="col-md-12 intro-info order-md-first order-last">
            ...
            <?php } else { ?>
              ...
              <div class="row">
                <a href="<?php echo get_template_directory_uri(); ?>/img/duos_manual.pdf" target="_blank" data-wow-duration="2.4s" class="bounceInUp wow btn btn-primary pay_info">Как оплатить доступ?</a>
              </div>
