            ...
            <?php } ?>
                <?php if(is_user_logged_in()){ ?>
                    ...
                    <?php if(current_user_can('contributor') || current_user_can('administrator')) { ?>
                        ...
                        <div class="btn-group">
                          <a href="/wizard" class="btn btn-default btn-large before_start">Начать</a>
                          <a href="/kabinet" class="btn btn-default btn-large">Личный кабинет</a>
                          <a href="https://cloud.mail.ru/public/65BR/F9yAr4XiK" target="_blank" class="btn btn-warning btn-large">Руководство пользователя</a>
    ...
    <?php if(!is_user_logged_in() || current_user_can('subscriber')){ ?>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="vitrin vitrin-content vitrin-centered">
                        Стоимость получения доступа к программе на 1 год составляет <div class="vitrin-price">35 000 руб.</div> Через год и далее Вы сможете продлить Вашу учетную запись за <div class="vitrin-price">24 990 руб.</div>
                        <a name="howto"></a>
                    </div>
        ...
        <footer class="footer vitrin" role="contentinfo">
            <div id="inner-footer" class="wrap cf">
                <p class="source-org copyright">© 2018 <a class="homelink" href="<?php echo home_url(); ?>/wp-login.php?action=logout&amp;_wpnonce=a6cad512ba">Выйти</a> Версия 3.0 <a href="/oferta">Оферта</a><span class="supportlink">Поддержка пользователей: <a href="mailto:info@chikurov.com">info@chikurov.com</a></span>
                </p>
            </div>
        </footer>
    <?php } ?>
