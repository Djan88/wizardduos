<?php 
	...
	<div class="mo2f_table_layout">
		...
		<ul class="mo2f_faqs">
			...
			<h3><a  data-toggle="mo2f_collapse" href="#question1" aria-expanded="false" ><li>How to enable PHP cURL extension? (Pre-requisite)</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question2" aria-expanded="false" ><li>I am getting error - curl_setopt(): CURLOPT_FOLLOWLOCATION cannot be activated when an open_basedir is set.
				</li></a></h3>
				...
				<?php if($mo_expand_value){ ?>
					<h3><a  data-toggle="mo2f_collapse" href="#question_adduser" aria-expanded="true" class><li>How to setup two factor for my users?
					</li></a></h3>
					<div class="mo2f_collapse in" id="question_adduser" aria-expanded="true">
				<?php }else{ ?>
					<h3><a  data-toggle="mo2f_collapse" href="#question_adduser" aria-expanded="false" ><li>How to setup two factor for my users?
					</li></a></h3>
					<div class="mo2f_collapse" id="question_adduser">
				<?php } ?>
					<ol>
						<li>Go to Login Settings tab in the plugin.</li>
						<li>Select the roles under <b>Select Roles to enable 2-Factor</b> header for which you want to set up two factor.</li>
						<li>Select the authentication methods under <b>Select the specific set of authentication methods for your users</b> header.</li>
						<li>Select the radio button of <b>Enforce 2 Factor registration for users at login time</b> under the <b>Invoke Inline Registartion to setup 2nd factor for users</b> header.</li>
						<li>Click on <b>Save Settings</b> button.</li>
						<li>Next time when the user will try to login then inline registration will be invoked that will ask the user to setup the 2nd factor.</li>
						<li>After your all users are registered successfully, make sure to turn off the inline registration by selecting the radio button of <b>Skip 2 Factor registration at login</b> </li>
					</ol>
				</div>
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question3" aria-expanded="false" ><li>I did not recieve OTP while trying to register with miniOrange. What should I do?
				</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question4" aria-expanded="false" ><li>I forgot the password of my miniOrange account. How can I reset it?
				</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question5" aria-expanded="false" ><li>I have a custom / front-end login page on my site and I want the look and feel to remain the same when I add 2 factor ?</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question6" aria-expanded="false" ><li>I have Woocommerce theme login page on my site. How can I enable Two Factor ?</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question7" aria-expanded="false" ><li>I am trying to login with Two-Factor but my screen got blank after entering username and password. I am locked out of my account. What to do now ?</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question8" aria-expanded="false" ><li>If you are using any Security Plugin in WordPress like Simple Security Firewall, All in One WP Security Plugin and you are not able to login with Two-Factor.</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question9" aria-expanded="false" ><li>If you are using any render blocking javascript and css plugin like Async JS and CSS Plugin and you are not able to login with Two-Factor or your screen got blank.</li></a></h3>
				...
				<hr>
				<h3><a  data-toggle="mo2f_collapse" href="#question10" aria-expanded="false" ><li>I want to enable 2-factor only for administrators ?</li></a></h3>
				...
				<hr>
			<h3><a  data-toggle="mo2f_collapse" href="#question11" aria-expanded="false" ><li>I want to enable 2 factor for administrators and end users ?</li></a></h3>
				...
				<h3><a  data-toggle="mo2f_collapse" href="#question12" aria-expanded="false" ><li>My phone has no internet connectivity, how can I login?</li></a></h3>
				...
				<hr>
			<h3><a  data-toggle="mo2f_collapse" href="#question13" aria-expanded="false" ><li>My users have different types of phones. What phones are supported?</li></a></h3>
				...
				<hr>
			<h3><a  data-toggle="mo2f_collapse" href="#question14" aria-expanded="false" ><li>What if a user does not have a smart phone?</li></a></h3>
				...
				<hr>
			<?php }?>	
			<h3><a data-toggle="mo2f_collapse" href="#question15" aria-expanded="false" ><li>What if I am trying to login from my phone ?</li></a></h3>
			...
			<h3><a  data-toggle="mo2f_collapse" href="#question16" aria-expanded="false" ><li>I want to hide default login form and just want to show login with phone?</li></a></h3>
				...
				<hr>
			<?php }?>
			<h3><a  data-toggle="mo2f_collapse" href="#question17" aria-expanded="false" ><li>My phone has no internet connectivity, how can I login?</li></a></h3>
				...
				<hr>
			<h3><a  data-toggle="mo2f_collapse" href="#question18" aria-expanded="false" ><li>My phone is lost, stolen or discharged. How can I login?</li></a></h3>
				...
				<hr>
			<h3><a  data-toggle="mo2f_collapse" href="#question19" aria-expanded="false" ><li>My phone has no internet connectivity and i am entering the one time passcode from miniOrange Authenticator App, it says Invalid OTP.</li></a></h3>
			...
			<h3><a  data-toggle="mo2f_collapse" href="#question20" aria-expanded="false" ><li>I want to go back to default login with password.</li></a></h3>
